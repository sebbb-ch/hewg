...
TODO: Load in an existing map as a 
...
CANVAS_SURFACE      = DISPLAY_WINDOW.subsurface(canvas_rect)
...
TILE_PALETTE        = load_dir('tiles-16')
ERASER_SPRITE       = load_image('assets/eraser.png')
